            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white @guest shadow-sm @endguest">
                <div class="container">
                    <a class="navbar-brand py-3" href="{{ url('/') }}">
                        <img src="http://androidmakassar.com/wp-content/uploads/2019/08/anro-6.png" alt="Android Makassar">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @guest
                                <li class="nav-item">
                                    <a class="nav-link font-weight-bold text-uppercase" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
                            @else
